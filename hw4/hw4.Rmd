...
```
There is a very slight trend upwards in the mean record time, although it varies so much from year to year that any given year could have a much larger or smaller mean than another in the dataset. About one half to two-thirds of the record time data is approximately 90 days. It is worth noting that although the mean for 2021 appears lower than the past ~10 years, these data were released in May of that year, so the end result was likely larger.
