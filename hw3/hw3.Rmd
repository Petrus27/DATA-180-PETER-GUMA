...
```{r}
ggplot(Cars93, aes(EngineSize, MPG.city)) + geom_point(size=2,col="blue") + xlim(1,6) + ylim(10,50) + labs(title = "The Relationship Between Engine Size and City MPG", subtitle="For 93 Cars on Sale in the USA in 1993") + xlab("Engine Size") + ylab("City MPG")
```
...
```{r}
ggplot(Cars93, aes(EngineSize, MPG.city)) + geom_point(size=2,col=1:length(Cars93$Type)) + xlim(1,6) + ylim(10,50) + labs(title = "The Relationship Between Engine Size and City MPG", subtitle="For 93 Cars on Sale in the USA in 1993") + xlab("Engine Size") + ylab("City MPG")
```
...
```{r}
ggplot(Cars93, aes(EngineSize, MPG.city)) + geom_point(size=2,col=1:length(Cars93$Type)) + xlim(1,6) + ylim(10,50) + labs(title = "The Relationship Between Engine Size and City MPG", subtitle="For 93 Cars on Sale in the USA in 1993") + xlab("Engine Size") + ylab("City MPG") + geom_smooth(col="red", linetype = "dashed")
```
