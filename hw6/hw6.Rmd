...
The elbow plot suggests that three clusters is ideal because the difference in WGSS begins to rapidly level off after K=3. This differs from my impression from the dendrogram in Question 2 because there it looks like four clusters is ideal for grouping all the mammals logically. I would argue that both K=3 and K=4 would work fine, though three clusters are slightly better from an optimization standpoint.
